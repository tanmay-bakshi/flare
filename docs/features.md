...
| `WsSender.send_*_until()` — whole-frame publication through an absolute monotonic deadline; expiry requires immediate connection shutdown | [`tests/ws/test_ws_duplex_deadline.mojo`](../tests/ws/test_ws_duplex_deadline.mojo) |
